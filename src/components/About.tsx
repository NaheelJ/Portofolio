        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-16">
          <motion.div initial={{opacity:0,x:-40}} animate={isInView?{opacity:1,x:0}:{}} transition={{duration:0.8, ease:[0.16, 1, 0.3, 1], delay:0.2}}>
            ...
            <div className="space-y-4 leading-relaxed" style={{color:"#adb5bd"}}>
              <p>With 1 year of experience in software development, I specialize in architecting and delivering high-performance applications using Flutter, Firebase, Node.js, and Google Cloud Platform.</p>
