          ...
          <div className="relative">
            ...
            {experiences.map((exp, index) => (
              <motion.div
                ...
                } md:w-1/2 ${index % 2 === 0 ? "md:pr-12" : "md:ml-auto md:pl-12"}`}
              >
                {/* Timeline dot */}
                <div
                  className={`absolute left-8 md:left-auto ${
                    index % 2 === 0 ? "md:right-0" : "md:left-0"
                  } w-4 h-4 bg-primary rounded-full transform md:-translate-x-1/2 ${
                ...
                <motion.div
                  ...
                  className="ml-16 md:ml-0 glass-morphism p-6 rounded-lg neon-border-purple hover:neon-glow-purple transition-all"
                >
